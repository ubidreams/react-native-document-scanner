...
## Credits
- for iOS : [SwiftCamScanner](https://github.com/Srinija/SwiftCamScanner)
- for Android : [SimpleDocumentScanner-Android](https://github.com/jbttn/SimpleDocumentScanner-Android)
- for perspective correction and image cropping : [react-native-perspective-image-cropper](https://github.com/Michaelvilleneuve/react-native-perspective-image-cropper)